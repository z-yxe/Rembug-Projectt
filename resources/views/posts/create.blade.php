        ...
        <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4 pt-2">
                ...
                <textarea id="caption" 
                          ...
                          placeholder="Write a caption for your post...">{{ old('caption') }}</textarea>
                @error('caption')
            ...
            <div class="mb-4">
                ...
                <input type="file" 
                       class="form-control visually-hidden @error('image') is-invalid @enderror" 
                       id="image" 
                       name="image"
                       accept="image/jpeg,image/png,image/gif"
                       onchange="document.getElementById('fileNameDisplay').textContent = this.files.length > 0 ? this.files[0].name : 'No file chosen';">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-5 pt-3" style="border-top: 1px solid var(--border-color);">
                <button type="submit" class="btn btn-primary-themed px-4 py-2"
